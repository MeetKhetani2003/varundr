        ...
        <div className="main-container mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8 text-center md:text-left">
          <div className="max-w-2xl mx-auto md:mx-0">
            ...
            <p className="text-lg md:text-xl text-slate-600 mt-6 leading-relaxed">
              Explore our state-of-the-art facility designed for maximum patient comfort and diagnostic precision. From latest Digital Xray Fuji DR system to high Precision lab.
            </p>
          </div>
      ...
      <section className="section-padding bg-white relative overflow-hidden">
        ...
        <div className="main-container mb-20 text-center">
          <div className="inline-flex items-center gap-2 mb-4 bg-slate-50 px-4 py-2 rounded-full shadow-sm border border-slate-100">
            ...
            <span className="text-slate-500 text-sm font-bold uppercase tracking-wider">100+ Reviews</span>
          </div>
          <SectionHeading title="What Our Patients Say" centered />
            <div className="flex items-center justify-center gap-4 mt-6">
              <a
                href="https://www.google.com/search?q=Care+Plus+Healthcentre&lrd=0x3a28c3664d50f55f:0xc3c9448f80456565,1,,,"
                target="_blank"
              ...
              <a
                href="https://www.google.com/search?q=Care+Plus+Healthcentre&lrd=0x3a28c3664d50f55f:0xc3c9448f80456565,3,,,"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-teal-50 hover:bg-teal-100 text-teal-800 font-bold border border-teal-200 transition-all text-sm group"
              >
                Write a Review <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
              </a>
            </div>
        </div>
