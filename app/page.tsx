        ...
        <div className="main-container mb-20 text-center">
          ...
          <div className="flex flex-col items-center gap-6 mt-8">
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-white border border-slate-200 text-slate-700 hover:text-slate-900 rounded-2xl font-bold shadow-lg shadow-slate-200/50 hover:shadow-xl hover:-translate-y-1 transition-all group"
            >
