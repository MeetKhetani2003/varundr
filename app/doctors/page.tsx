          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-12">
            {DOCTORS.map((doc, idx) => (
              <motion.div
                ...
                className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden p-8 flex flex-col hover:shadow-xl transition-all cursor-pointer group"
              >
                ...
                <div className="flex gap-6 mb-8">
                  <div className="relative shrink-0">
                    ...
                    <div className="absolute -top-1 -right-1 bg-brand-teal text-white rounded-full p-1 border-2 border-white z-20">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-brand-teal font-bold text-sm mb-3">{doc.qualifications.split(',')[0]}</div>
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  ...
                  <span className="px-3 py-1.5 text-xs font-bold text-brand-teal">+1 more</span>
                </div>

                {/* Buttons */}
                <div className="flex flex-col gap-3">
                  <button 
                    onClick={(e) => { e.stopPropagation(); openModal(doc.id); }}
                    className="w-full h-14 bg-brand-teal hover:brightness-90 text-white rounded-2xl font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-teal-900/20"
                  >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <button 
                      onClick={(e) => { e.stopPropagation(); window.open('https://wa.me/917701010703', '_blank'); }}
